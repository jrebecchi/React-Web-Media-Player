...
var _StateInitiator = require('./services/StateInitiator');
...
var ReactWebMediaPlayer = function (_Component) {
  ...
  function ReactWebMediaPlayer(options) {
    ...
    _this.store.dispatch({ type: 'INIT_STATE', payload: { state: (0, _StateInitiator.getInitState)(_this.props) } });
    return _this;
  }
...
exports.default = ReactWebMediaPlayer;
