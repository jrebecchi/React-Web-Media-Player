...
const playLogo =
    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" className="play-logo">
        <path className="wmp-tool-button-logo" fill="#e4e5e8" d="M8 5v14l11-7z" />
        <path d="M0 0h24v24H0z" fill="none" />
    </svg>

const pauseLogo =
    <svg xmlns="http://www.w3.org/2000/svg" width="29" height="29" viewBox="0 0 24 24" className="pause-logo">
        <path className="wmp-tool-button-logo" fill="#e4e5e8" d="M6 19h4V5H6v14zm8-14v14h4V5h-4z" />
        <path d="M0 0h24v24H0z" fill="none" />
    </svg>

const replayLogo =
    <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 24 24" className="replay-logo">
        <path d="M0 0h24v24H0z" fill="none" />
